...
abstract class D5700Instruction(
	protected val cpuMemory : D5700CPURegisters
)
{
	companion object
	{
		private val instructionMap = mapOf<Int, (D5700CPURegisters) -> D5700Instruction> (
		...
		fun perform(descriptor : Short, cpuMemory : D5700CPURegisters)
		{
